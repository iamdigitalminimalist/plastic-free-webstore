...
export const Success = ({ products }: SuccessPageProps) => {
  ...
  const showOrderSummaryCondition = isTabletOrMobile ? showOrderSummary : true; // true for desktop but only conditionally true for mobile

  const handleShowOrderSummary = () => {
    setShowOrderSummary(!showOrderSummary);
  };

  const orderSubtotal = products.reduce(
  ...
  return (
    <div>
      <Head>
        <title>Thank You for Choosing Plastic Free</title>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-9">
        <section className="order-2 mx-auto max-w-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
          ...
          <div className="mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14">
            <div className="space-y-2 pb-3">
              ...
              <p className="text-sm text-gray-600">{`We've accepted your order, and we're getting it ready. Come back to this page for updates on your shipment status`}</p>
            </div>
            <div className="flex space-x-1 pt-3 text-sm">
              <p className="font-medium text-gray-600">Your tracking number:</p>
              <p>ABC12345678</p>
            </div>
          </div>
          ...
          <div className="my-4 mx-4 space-y-2 rounded-md border border-gray-300 p-4 lg:ml-14">
            <p>Order updates:</p>
            <p className="text-sm text-gray-600 ">{`You'll get shipping and delivery updates by email and text`}</p>
          </div>
        ...
        {mounted ? (
          <section className="overflow-y-scroll border-y border-l border-gray-300 bg-[#FAFAFA] lg:order-2 lg:col-span-4 lg:h-screen lg:border-y-0">
            <div
              className={`w-full ${
                showOrderSummaryCondition ? "border-b" : undefined
              } border-b-300 text-sm lg:hidden`}
            >
              <div className="mx-auto flex max-w-xl items-center justify-between px-4 py-6">
                ...
                <p className="text-lg font-medium text-black">
                  <Currency quantity={orderSubtotal + 20} />
                </p>
              </div>
            </div>
              ...
              <div className="mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0 lg:max-w-lg lg:px-10 lg:py-16">
                <div className="space-y-4 pb-4">
                  {products.map((product) => (
                    ...
                    >
                      <div className="relative flex h-16 w-16 items-center justify-center rounded-md border border-gray-300 bg-[#f1f1f1] text-sm text-white">
                ...
                <div className="space-y-1 py-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <p className="font-medium">
                      <Currency quantity={orderSubtotal} />
                    </p>
                  </div>
                  <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between pt-4">
                  <p>Total</p>
                  <p className="flex items-center gap-x-2 text-xs text-gray-800">
                    CAD
